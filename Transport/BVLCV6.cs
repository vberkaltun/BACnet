...
namespace System.IO.BACnet
{
	...
	public class BVLCV6
	{
		...
		public int Encode(byte[] buffer, BacnetBvlcV6Functions function, int msgLength, BacnetAddress address)
		{
		...
		public int Decode(byte[] buffer, out BacnetBvlcV6Functions function, out int msgLength, IPEndPoint sender,
